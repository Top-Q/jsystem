...
public class TestsExamples extends SystemTestCase4 {
	...
	private String str = "C:\\tests\\test2";
	private int i = 5;
	...
	public void before() throws Throwable{
		super.defaultBefore();
		RunProperties.getInstance().setRunProperty("demoPath", "C:\\tests\\tests.txt");
	}
	...
	public void testWithParameterProvider() throws IOException {
		...
		report.report("account file name: "+account.getFile());
	...
	public void testWithParameters() {
		//RunProperties.getInstance().setRunProperty("testPath","C:\\tests\\test2.txt");
