...
public class XPathAttribContainText extends DocumentAnalyzer {
	String xpath;
	String value;
	String attrib;
	public XPathAttribContainText(String xpath,String attrib, String value){
		this.xpath = xpath;
		this.value = value;
		this.attrib = attrib;
	}
	public void analyze() {
		title = "XPathAttribContainText: xpath: " + xpath +",attrib: " + attrib + ", value: " + value;
		try {
