...
public class AdvancedTestParametersTest extends SystemTestCase {
	/**
	 * Demo type
	 */
	...
	public void testDateParameter() throws Exception {
		RunProperties.getInstance().setRunProperty("FileParameterTest_file", getDate().toString());
	}
	...
	@ParameterProperties(section = "Files")
	...
	@ParameterProperties(section = "Demo Type")
