...
/**
 * TestProperties annotation example.
 * @author goland
 */
public class TestPropertiesAnnotationExample extends SystemTestCase {
	...
	/**
	 */
	@TestProperties(name="Pings to destination ${pingDestination}",paramsInclude={"pingDestination","packetSize"})
	 ...
	 */
	@ParameterProperties(description="desc")
