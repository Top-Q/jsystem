...
public abstract class CliConnectionImpl extends SystemObjectImpl implements CliConnection {
    ...
    private void internalConnect() throws Exception {
        ...
        } else if (protocol.toLowerCase().equals(EnumConnectionType.DEPRECATED_SSH.value())) {
    ...
    public void disconnect() {
        ...
        if (cli != null) {
            try {
                ...
                System.out.println("Failed closing cli connection: " + e.getMessage());
            }
        }
    }
     ...
     * Whether to ignore backspace characters or not
     *
     * @param ignoreBackSpace true to ignore backspace characters, false otherwise
     */
