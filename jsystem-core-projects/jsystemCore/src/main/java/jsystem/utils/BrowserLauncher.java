...
public class BrowserLauncher {
	...
	private static Object locateBrowser() {
		...
		String tb = JSystemProperties.getInstance().getPreference(
	...
	public static void openURL(String url) throws IOException {
		String error = "Couldnt locate the default browser of the system you are working on \n "
			+ "Please add manualy the parameter <bold>browser=<browser></bold> \n"
			+ "to the jsystem.propreties found in your tests folder\n";
		...
		if (browser == null) {
			...
			throw new IOException("Unable to locate browser: " + error + errorMessage);
		}
