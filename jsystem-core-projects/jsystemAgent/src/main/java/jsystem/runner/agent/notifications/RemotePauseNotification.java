...
public class RemotePauseNotification extends RunnerNotification {

	private static final long serialVersionUID = -1454998534692015142L;
	public RemotePauseNotification(Object source) {
		super(RemotePauseNotification.class.getName(), source);
	}
	public void invokeDispatcher(JSystemListeners dispatcher){
		dispatcher.remotePause();
	}
