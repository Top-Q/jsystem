...
public class BackgroundPublisherWaitDialog extends WaitDialog {
	 ...
	 * 
	 */
	public BackgroundPublisherWaitDialog(Frame parent, String title) {
		super(parent, title);
		this.parent = parent;
		this.title = title;
		/*
	...
	public BackgroundPublisherWaitDialog(Dialog parent, String title) {
		super(parent, title);
		this.parent = parent;
		this.title = title;
		/*
	...
	public BackgroundPublisherWaitDialog() {
		setTitle("Uploading...");
	...
	public synchronized static void launchWaitDialog(final String title) {
		 ...
		 */
		dialog = new BackgroundPublisherWaitDialog(TestRunnerFrame.guiMainFrame, title);
		(new Thread() {
			public void run() {
