...
public final class Enumerations {
        ...
        * @return the enumeration over the array of enumerations.
         */
        public static<T> Enumeration<T> fromCompound(Enumeration<T>[] enums) {
                return new CompoundEnumeration<T>(enums);
        }
 ...
 */
 class CompoundEnumeration<T> implements Enumeration<T> {
        ...
        /** enumeration array */
        private Enumeration<T>[] enumArray;

        /** index in the enums array */
        private int index = 0;

    public CompoundEnumeration(Enumeration<T>[] enumarray) {
