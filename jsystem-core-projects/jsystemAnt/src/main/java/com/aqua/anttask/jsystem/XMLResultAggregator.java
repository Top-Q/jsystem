...
public class XMLResultAggregator extends Task implements XMLConstants {
    ...
    protected Vector<AggregateTransformer> transformers = new Vector<AggregateTransformer>();
    ...
    public void execute() throws BuildException {
        ...
        Enumeration<AggregateTransformer> e = transformers.elements();
        while (e.hasMoreElements()) {
            AggregateTransformer transformer = e.nextElement();
